      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
        <div className="max-w-4xl">
          ...
          <motion.p
            ...
            className="text-green-200 text-base sm:text-lg leading-relaxed mb-8 sm:mb-10 max-w-2xl"
          >
          ...
          >
            ...
            <Link
              href="/admissions"
              className="group flex items-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 bg-[#C41E1E] text-white font-bold text-sm sm:text-base rounded-xl hover:bg-[#9B1515] transition-all duration-300 shadow-lg hover:shadow-[#C41E1E]/30 hover:shadow-2xl hover:-translate-y-0.5"
            >
              Apply Now
            ...
            <Link
              href="/academics"
              className="group flex items-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 border-2 border-white/30 text-white font-semibold text-sm sm:text-base rounded-xl hover:border-[#D4A820] hover:text-[#F0D060] transition-all duration-300"
            >
